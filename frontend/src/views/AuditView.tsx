...
export function AuditView({ onNav }: Props) {
  ...
  const allEntries: DisplayEntry[] = dbEntries
    .filter(e => filterType === 'all' || eventType(e.event) === filterType)
    .map(dbToDisplay)
        ...
        {allEntries.length === 0 && (
          <div className="empty">
            ...
            <div className="empty-desc">
              Entries appear here as jobs run. Run a sync job to see events.
            </div>
